 ...
 */
import { d as doc, N as NAMESPACE, w as win, p as promiseResolve, b as bootstrapLazy } from './index-a66b15c9.js';
import { g as globalScripts } from './app-globals-7a738012.js';
import './ionic-global-251fa371.js';
...
const patchBrowser = () => {
    ...
    if (importMeta !== '') {
        ...
        if (!win.customElements) {
            ...
            // @ts-ignore
            return import(/* webpackChunkName: "polyfills-dom" */ './dom-08898640.js').then(() => opts);
        }
    }
