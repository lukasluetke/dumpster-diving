...
const index = require('./index-288cb6f0.js');
const ionicGlobal = require('./ionic-global-a8903eb2.js');
...
const index$1 = require('./index-258eb806.js');
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
          Promise.resolve().then(function () { return require('./status-tap-bb7ab8e4.js'); }).then(module => module.startStatusTap());
        }
...
let RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await Promise.resolve().then(function () { return require('./swipe-back-e8176dee.js'); })).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
      if (this.ani) {
        this.ani.onFinish(() => {
          this.gestureOrAnimationInProgress = false;
          if (this.swipeHandler) {
